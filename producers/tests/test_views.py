...
def test_create_producer_with_valid_cpf(api_client, producer_list_url):
    payload = {
        "name": "Produtor Teste",
        "document_type": "CPF",
        "document": "11144477735",
...
def test_update_producer(api_client, producer_detail_url):
    ...
    response = api_client.patch(
        producer_detail_url(producer), payload, format="json"
    )
...
def test_create_producer_with_valid_cnpj(api_client, producer_list_url):
    payload = {
        "name": "Produtor Teste",
        "document_type": "CNPJ",
        "document": "24970180000100",
...
def test_create_producer_with_duplicate_document(api_client, producer_list_url):
    Producer.objects.create(
        name="Produtor Teste",
        document_type="CPF",
        document="60435059084",
